  ...
  <section class="first_section">
    <div class="container">
      <div class="position-relative">
        <div class="purple_block mw-100">
          <div class="position-absolute">
            <img src="../assets/img/first_section/first_line.svg" alt="line" class="mw-100 first_line">
          </div>
          <div class="position-absolute">
            <img src="../assets/img/first_section/second_line.svg" alt="line" class="mw-100 second_line">
          </div>
          <div class="position-absolute">
            <img src="../assets/img/first_section/third_line.svg" alt="line" class="mw-100 third_line">
          </div>
          <div class="position-absolute">
            <img src="../assets/img/first_section/fourth_line.svg" alt="line" class="mw-100 fourth_line">
          </div>
          <div class="position-absolute">
